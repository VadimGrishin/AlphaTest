...
TEXTS = {
    ...
    'welcome':\
        "Здравствуй, {role_name} {bright_blue}{name}{color_end}!\n" \
        "Меня зовут {bright_blue}Дэкой{color_end}. " \
    ...
    'selected_treasure': 'Выбрано сокровище: "{}".\n',
    'empty_chest': 'Увы, сундучок пуст. Кто-то тебя опередил\n',
}
